...
function validate(PDO $PDO){
    if(!isset($_POST["title"]) || empty($_POST["title"])) {
        echo '<p style="color: red; font-weight: bold;">titulo\'article</p>';
    }
    elseif(!isset($_POST["title"]) || empty($_POST["author"])) {
        echo '<p style="color: red; font-weight: bold;">nombre\'article</p>';
    }
    elseif(!isset($_POST["content"]) || empty($_POST["content"])) {
        echo '<p style="color: red; font-weight: bold;">contenido\'article</p>';
    }else{
